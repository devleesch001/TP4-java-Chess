...
public class Queen extends Piece {
     ...
     * @param color Color
     */
    public Queen(ChessBoard board, Coord place, Color color) throws IllegalPosition {
    ...
    public boolean isValideMove(Coord newPlace) throws IllegalPosition {
        ...
        if (Math.abs(diff.getX()) != Math.abs(diff.getY()) && Math.abs(diff.getX()) != 0 && Math.abs(diff.getY()) != 0) {
            return false;
        }
